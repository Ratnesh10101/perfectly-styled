      ...
      <Card className="w-full max-w-2xl shadow-xl">
        <CardHeader className="pb-4">
          ...
          <CardDescription className="text-lg text-muted-foreground pt-2">
            Discover your unique style identity. Our analysis helps you understand your body shape and scale to curate a wardrobe that truly represents you.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
            <div className="p-4 border rounded-lg bg-background">
             ...
             <div className="p-4 border rounded-lg bg-background">
              <h3 className="font-semibold text-lg mb-1">Style Clarity</h3>
              <p className="text-sm text-muted-foreground">Understand your line, scale, and body shape effectively.</p>
            </div>
             <div className="p-4 border rounded-lg bg-background">
