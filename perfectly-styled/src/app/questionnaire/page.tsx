...
export default function QuestionnairePage() {
  ...
  const handleSubmit = async (data: QuestionnaireData) => {
    try {
      ...
      toast({ title: "Questionnaire Completed!", description: "Please provide your email to receive your report." });
      router.push("/payment"); // This will now be the "get report by email" page
    } catch (error) {
